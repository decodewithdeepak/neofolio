...
import { HiTrendingUp, HiCode, HiStar, HiPuzzle, HiCheck, HiChartBar, HiServer } from 'react-icons/hi';
  ...
  const renderGithubActivity = () => {
    ...
    return (
      <motion.div
        ...
        className="p-4 sm:p-6 rounded-xl bg-gradient-to-br from-gray-800/60 to-gray-900/20
      ...
      >
        {/* Header with Link */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Main Stats Card */}
            <div className="relative overflow-hidden bg-gray-900/20 rounded-lg p-1 border border-gray-700/30">
              <img
  ...
  const renderLeetcodeActivity = () => {
      ...
      return (
        <motion.div
          className="flex items-center justify-center p-8 rounded-xl border border-blue-500/20
                   backdrop-blur-md bg-gray-800/20"
        >
    ...
    return (
      <motion.div
        ...
        className="p-4 sm:p-6 rounded-xl bg-gradient-to-br from-gray-800/60 to-gray-900/20 
           border border-gray-700/20
           shadow-lg backdrop-blur-lg hover:border-yellow-500/30 transition-all duration-300"
      >
        {/* Background Effect */}
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4 mb-6 relative">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-sm">
            <div className="px-3 py-1 rounded-full bg-gray-800/30 border border-gray-700/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
          {[
            ...
            >
              ...
              <div>
                <p className="text-xs sm:text-sm text-gray-300">{category.label}</p>
