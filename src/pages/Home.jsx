...
const HeroSection = ({ isVisible, renderCTAButtons }) => (
  <div className="relative pt-16">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <CodeSnippet isVisible={isVisible} animationDelay={0.8} />
    </div>
  </div>
);
...
const TestimonialsSection = ({ testimonials, isVisible }) => (
  <motion.div
    initial={{ opacity: 0, y: 40 }}
    animate={{ opacity: isVisible ? 1 : 0, y: isVisible ? 0 : 40 }}
    transition={{ delay: 1.4, duration: 0.8 }}
    className="max-w-5xl mx-auto px-4 pt-8 pb-16"
  >
    <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">
      <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">
        What our users say
...
const FinalCTASection = ({ isVisible }) => (
  <motion.div
...
const Home = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Hero Section */}
        <HeroSection isVisible={isVisible} renderCTAButtons={renderCTAButtons} />

        {/* Features Section */}
        <FeaturesSection features={features} isVisible={isVisible} />

        {/* Testimonials Section */}
        <TestimonialsSection testimonials={testimonials} isVisible={isVisible} />
